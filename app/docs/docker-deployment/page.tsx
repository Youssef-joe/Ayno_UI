        ...
        <section>
          ...
          <div className="space-y-3 text-muted-foreground">
            <div className="p-3 rounded border border-white/10 bg-white/5">
              <strong>Nginx</strong> - Load balancer on port 80
            </div>
            <div className="p-3 rounded border border-white/10 bg-white/5">
              <strong>Elixir/Phoenix</strong> - Gateway on port 4000
            </div>
            <div className="p-3 rounded border border-white/10 bg-white/5">
              <strong>Go Processor</strong> - Event processor on ports 8080 (HTTP) and 9090 (gRPC)
            </div>
            <div className="p-3 rounded border border-white/10 bg-white/5">
              <strong>Redis</strong> - Session store on port 6379
            </div>
            <div className="p-3 rounded border border-white/10 bg-white/5">
              <strong>PostgreSQL</strong> - Database on port 5432
            </div>
          </div>
        </section>
...
{`docker-compose ps`}
        ...
        <section>
          ...
          <div className="space-y-3 text-muted-foreground">
            ...
            <div className="p-3 rounded border border-yellow-500/20 bg-yellow-500/5">
              <strong>Build fails:</strong> Clear cache with <code className="bg-black/50 px-1 rounded text-xs">docker-compose build --no-cache</code>
            </div>
            <div className="p-3 rounded border border-yellow-500/20 bg-yellow-500/5">
