            ...
            {isOpen && (
                <div className="md:hidden glass-dark border-t">
                    <div className="px-4 py-4 space-y-4">
                        ...
                        <Link href="/docs" className="w-full px-4 py-2 bg-primary text-primary-foreground rounded-full font-medium hover:opacity-90 transition block text-center inline-block text-center">
                            View Docs
                        </Link>
                    </div>
                </div>
