...
const stats = [
  { label: "Active Connections", value: "2.5M+", color: "text-primary" },
  { label: "Messages/Second", value: "10M+", color: "text-accent" },
  { label: "Global Regions", value: "6", color: "text-emerald-400" },
